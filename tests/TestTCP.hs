...
testMaxLength = do
  ...
  Right serverTransport <- createTransport "127.0.0.1" "9998" $ defaultTCPParameters {
  ...
  Right goodClientTransport <- createTransport "127.0.0.1" "9999" defaultTCPParameters
  Right badClientTransport <- createTransport "127.0.0.1" "10000" defaultTCPParameters
